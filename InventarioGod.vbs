...
Set objFSO = CreateObject("Scripting.FileSystemObject")
  ...
  '--  STRcomputer =objNetwork.ComputerName
    ...
    objtextfile.WriteLine "<center><H1><b> Inventario do Servidor </b></h1></center>"
     objTextFile.WriteLine "<center><H1><b>Data do Relatório: "& Date &"--"& Time&"  </b></h1></center>"
   ...
   '
    ...
    Objtextfile.writeline "<Font face='arial'><h5><li><a href='#Veriis'>Versão do IIS</a></li></h5>"
...
Next
 ...
 objtextfile.WriteLine "<ul>"
   objtextfile.WriteLine "<li><b><h2><a name='#Veriis'> Versão do IIS </a></h2></b>"
   objtextfile.WriteLine "</ul>"
...
'---    ("VersaoIIS.html", ForAppending, True)
...
Set colFiles = objWMIService.ExecQuery _
    ("Select * from CIM_Datafile Where name =  'c:\\windows\\system32\\inetsrv\\inetinfo.exe'")
...
'----------------- gravando log
For Each objItem In colItems    
	objTextFile.WriteLine "IIS version: " & IIS
Next

Next

'---------------ler dir do inet-pub UNIDADE C:

Set FSO = CreateObject("Scripting.FileSystemObject")
ShowSubfolders FSO.GetFolder("C:\inetpub")
...
'---------------ler dir do inet-pub UNIDADE D INTRAPAO:

Set FSO = CreateObject("Scripting.FileSystemObject")
ShowSubfolders FSO.GetFolder("D:\intrapao")
Sub ShowSubFolders(Folder)
    For Each Subfolder in Folder.SubFolders
...
'---------------ler dir do inet-pub UNIDADE D INTRAGPA:

Set FSO = CreateObject("Scripting.FileSystemObject")
ShowSubfolders FSO.GetFolder("D:\intragpa")
Sub ShowSubFolders(Folder)
    For Each Subfolder in Folder.SubFolders
...
'---------------ler dir do inet-pub UNIDADE E INTRAPAO:

Set FSO = CreateObject("Scripting.FileSystemObject")
ShowSubfolders FSO.GetFolder("E:\intrapao")
Sub ShowSubFolders(Folder)
    For Each Subfolder in Folder.SubFolders
...
Set FSO = CreateObject("Scripting.FileSystemObject")
ShowSubfolders FSO.GetFolder("E:\intragpa")
Sub ShowSubFolders(Folder)
    For Each Subfolder in Folder.SubFolders
